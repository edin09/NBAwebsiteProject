...
document.addEventListener("DOMContentLoaded", () => {
   const signInLink = document.querySelector(".auth-link.sign-in");
...
document.addEventListener("DOMContentLoaded", () => {
   ...
   if (localStorage.getItem("isLoggedIn") === "true") {
      ...
      profilePic.src = localStorage.getItem("profilePic") || "images/user.jpg";
...
function loadSchedule() {
   ...
   // Dodaj timestamp za sprječavanje keširanja
...
// Učitavanje JSON fajla prilikom učitavanja stranice
document.addEventListener("DOMContentLoaded", () => {
...
function displayGames(filteredGames = games) {
   ...
   // Prikaz svih utakmica (skrolabilno), visina ograničava na ~5
...
// Separate script to update Get League Pass button text based on localStorage
